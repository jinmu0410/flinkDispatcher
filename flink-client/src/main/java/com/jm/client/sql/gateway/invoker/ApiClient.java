...
import com.jm.client.sql.gateway.auth.ApiKeyAuth;
import com.jm.client.sql.gateway.auth.Authentication;
import com.jm.client.sql.gateway.auth.HttpBasicAuth;
import okhttp3.*;
...
public class ApiClient {
    ...
    private String basePath = "http://192.168.201.75";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v2/1.18-SNAPSHOT/java");
