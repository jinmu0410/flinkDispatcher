...
public class ValueUtil {
    ...
    public static Integer parserStr(String strNum) {
        ...
        for (char num : nums) {
            if (CharUtils.isAsciiNumeric(num)) {
                newChar = ArrayUtils.add(newChar, num);
            }
        }
        return Integer.valueOf(String.valueOf(newChar));
