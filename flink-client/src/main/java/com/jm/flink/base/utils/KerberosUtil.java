...
import com.jm.flink.base.conf.KerberosConfig;
import com.jm.flink.base.constants.ConstantValue;
import com.jm.flink.base.exception.FlinkDoRuntimeException;
import com.jm.flink.bean.SftpHandler;
import org.apache.commons.collections.MapUtils;
import org.apache.commons.lang.StringUtils;
import org.apache.flink.api.common.cache.DistributedCache;
import org.apache.flink.shaded.zookeeper3.org.apache.zookeeper.server.auth.KerberosName;
...
public class KerberosUtil {
    ...
    static {
        ...
        if (systemInfo.toLowerCase().startsWith(ConstantValue.OS_WINDOWS)) {
            ...
            LOCAL_CACHE_DIR = "/tmp/flinkdo/keytab";
        }
