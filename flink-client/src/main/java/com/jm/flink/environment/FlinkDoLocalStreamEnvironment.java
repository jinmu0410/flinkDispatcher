...
package com.jm.flink.environment;
 ...
 * Flink本地作业环境
 *
 * <p>The FlinkDoLocalStreamEnvironment is a StreamExecutionEnvironment that runs the program
 * locally, multi-threaded, in the JVM where the environment is instantiated. It spawns an embedded
 ...
 */
@Public
public class FlinkDoLocalStreamEnvironment extends StreamExecutionEnvironment {

    private static final Logger LOG = LoggerFactory.getLogger(FlinkDoLocalStreamEnvironment.class);
     ...
     */
    public FlinkDoLocalStreamEnvironment() {
     ...
     */
    public FlinkDoLocalStreamEnvironment(@Nonnull Configuration configuration) {
    ...
    public JobExecutionResult execute(String jobName) throws Exception {
        ...
        try {
            ...
            miniCluster.close();
            LOG.info("Running job on local miniCluster clear and close end!");
        }
    }
}
