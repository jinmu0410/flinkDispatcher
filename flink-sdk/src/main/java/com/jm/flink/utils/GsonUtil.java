...
public class GsonUtil {
    ...
    public static Gson NO_PRETTY_GSON = getNoPrettyPrinting();

    public static Type gsonMapTypeToken = new TypeToken<HashMap<String, Object>>() {
    }.getType();
    ...
    private static Gson getNoPrettyPrinting() {
        NO_PRETTY_GSON = new GsonBuilder().disableHtmlEscaping().create();
        return setTypeAdapter(NO_PRETTY_GSON);
    }
    ...
    public static Gson setTypeAdapter(Gson gson) {
        try {
            ...
            LOG.error("setTypeAdapter error:{}", e.getMessage(), e);
        }
        return gson;
    }
}
